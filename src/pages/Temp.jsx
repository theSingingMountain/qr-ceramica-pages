    ...
    async function getFiles(images) {
        ...
        const jimpImages = images.map((img) => new Promise(async (resolve, reject) => {
            try {
                ...
                jimpImage.resize(Math.min(1000, jimpImage.bitmap.width), Jimp.AUTO, Jimp.RESIZE_BICUBIC)
            ...
            <div className="product--container">
                ...
                <div className='preview--container'>
                    ...
                    <div className="images--preview">
                        <div id="preview">{imgSrc && <img src={`data:image/png;base64,${imgSrc}`} style={{maxWidth: "100%"}}></img>}</div>
                    </div>
                    }
                </div>
